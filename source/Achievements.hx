...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["A Funkin' Blast to The Past!",					"Complete Blast to The Past!",	'bttp_completed',				 false],
		["Anti-Piracy Detected.",					"Complete the Punishment Week, and get out alive...",	'pw_completed',				 true]
	];
